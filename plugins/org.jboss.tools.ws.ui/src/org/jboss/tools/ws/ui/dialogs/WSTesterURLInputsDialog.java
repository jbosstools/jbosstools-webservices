...
public class WSTesterURLInputsDialog extends TitleAreaDialog {
			...
			public String getColumnText(Object element, int columnIndex) {
				if (element instanceof URLTemplateParameter) {
					...
					if (columnIndex == 0) {
						...
						// suffix the parameter name with an asterix to indicate it is mandatory.
	...
	/**
	 * Validate all parameters and return an error message as soon as one param is invalid
