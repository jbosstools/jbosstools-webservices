...
public class JBossWSFacetInstallPage extends AbstractFacetWizardPage implements
	...
	public void setConfig(Object config) {
		...
		setTitle(MessageFormat.format(JBossJAXWSUIMessages.JBossWSFacetInstallPage_Title, JbossWSVersion)); 
		setDescription(MessageFormat.format(JBossJAXWSUIMessages.JBossWSFacetInstallPage_Description, JbossWSVersion));
	}
