...
/**
 * This class contains utility methods for managing URLs as used by the Web
 * Services Explorer Web application.
 * 
...
public final class URLUtils {
	...
	/**
	 * Equivalent to {@link #encode(String,String)} with second parameter set to the
	 * "UTF-8" encoding.
	 * 
	 * @param s
	...
	/**
	 * Equivalent to {@link URLEncoder#encode(String,String)}, only throws an
	 * unchecked {@link RuntimeException} wrapped around an
	 * {@link UnsupportedEncodingException} instead of an
	...
	/**
	 * Equivalent to {@link #decode(String,String)} with second parameter set to the
	 * "UTF-8" encoding.
	 * 
	 * @param s
	...
	/**
	 * Equivalent to {@link URLEncoder#decode(String,String)}, only throws an
	 * unchecked {@link RuntimeException} wrapped around an
	 * {@link UnsupportedEncodingException} instead of an
	 * {@link UnsupportedEncodingException}.
	 * 
