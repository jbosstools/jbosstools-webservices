...
import org.jboss.tools.ws.jaxws.ui.widgets.Java2WSDLCodeGenConfigWidget;
...
public class JBossWSJava2WSDLConfigWidgetFactory implements
	...
	public void registerDataMappings(DataMappingRegistry dataRegistry) {
		...
		dataRegistry.addMapping(InitialCommand.class, JBossJAXWSUIMessages.JBossWS_WebServiceDataModel,
	...
	private void init() {
		...
		servicesXMLSelectWidgetContrib = createWidgetContributor(
				JBossJAXWSUIMessages.JBossWSJava2WSDLConfigWidgetFactory_Title,
				JBossJAXWSUIMessages.JBossWSJava2WSDLConfigWidgetFactory_Description,
				java2WSDLWidget);
	}
