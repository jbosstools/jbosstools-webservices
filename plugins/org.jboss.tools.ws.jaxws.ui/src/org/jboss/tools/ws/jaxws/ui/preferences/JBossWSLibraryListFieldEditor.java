...
public class JBossWSLibraryListFieldEditor extends BaseFieldEditor {
	...
	public Object[] getEditorControls(Object composite) {
		...
		jarGroup.setText(JBossJAXWSUIMessages.JBossWSLibraryListFieldEditor_LIBRARY_JARS);
	...
	protected void createCheckButton(Composite parent) {
		...
		btnDefault.setText(JBossJAXWSUIMessages.JBossWS_Runtime_Check_Field_Default_Classpath);
		GridData gd = new GridData();
		gd.horizontalSpan = 2;
	...
	protected void createListView(Composite parent) {
		...
		listView.setLabelProvider(new ILabelProvider() {
			...
			public Image getImage(Object element) {
				if (jarImg == null) {
					ImageDescriptor jarImgDesc = JBossWSUIPlugin.getImageDescriptor("obj16/jar_obj.gif"); //$NON-NLS-1$
	...
	protected void createActionBar(Composite parent) {
		actionPanel = new ActionPanel(parent, new BaseAction[] { new AddAction(), new RemoveAction() });
	...
	public class AddAction extends BaseAction {
		 ...
		 */
		public AddAction() {
			super(JBossJAXWSUIMessages.JBossWSLibraryListFieldEditor_ActionAdd);
	...
	public class RemoveAction extends BaseAction {
		 ...
		 */
		public RemoveAction() {
			super(JBossJAXWSUIMessages.JBossWSLibraryListFieldEditor_ActionRemove);
		}
