...
public class JBossCreationUIUtils {
	...
	public static void populateTargetCombo(Combo targetCombo, ServiceModel model) {
		targetCombo.add(JBossJAXWSUIMessages.Value_Target_0, 0);
		targetCombo.add(JBossJAXWSUIMessages.Value_Target_1, 1);
		targetCombo.add(JBossJAXWSUIMessages.Value_Target_2, 2);
		if (JBossJAXWSUIMessages.Value_Target_0.equals(model.getTarget())) {
			targetCombo.select(0);
		} else if (JBossJAXWSUIMessages.Value_Target_1.equals(model.getTarget())) {
