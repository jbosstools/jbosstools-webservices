...
package org.jboss.tools.ws.jaxws.ui.classpath;
...
AbstractClasspathContainerInitializer {
	...
	public void initialize(IPath containerPath, IJavaProject project)
		...
		if (containerPath.segment(0).equals(
				JBossJAXWSUIMessages.JBossWS_Runtime_Lib)) {
	...
	AbstractClasspathContainer {
		...
		public JBossWSRuntimeClasspathContainer(IPath path, IJavaProject javaProject) {
			super(path,JBossJAXWSUIMessages.JBossWS_Runtime_Lib,null, javaProject);
			this.path = path;
		}

		public String getDescription() {
			return JBossJAXWSCoreMessages.JBossWS_Runtime;
		}
