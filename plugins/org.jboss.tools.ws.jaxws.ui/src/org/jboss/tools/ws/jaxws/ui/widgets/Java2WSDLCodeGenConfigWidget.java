...
public class Java2WSDLCodeGenConfigWidget extends
	...
	public WidgetDataEvents addControls(Composite parent,
		...
		sourceCombo = JBossCreationUIUtils.createComboItem(configCom, model,JBossJAXWSUIMessages.Label_SourceFolder_Name ,JBossJAXWSUIMessages.Tooltip_SourceFolder);
		...
		wsdlGen.setText(JBossJAXWSUIMessages.Label_Generate_WSDL);
		...
		btnUpdateWebxml.setText(JBossJAXWSUIMessages.Label_Update_Webxml);
