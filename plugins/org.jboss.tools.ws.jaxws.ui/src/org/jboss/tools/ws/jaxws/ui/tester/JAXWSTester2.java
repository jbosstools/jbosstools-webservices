...
public class JAXWSTester2 {
	...
	public void doTest(IProgressMonitor monitor, String endpointurl, String actionurl, String ns, String serviceName,
			String messageName, String body) throws Exception {
	...
	public void doTest(IProgressMonitor monitor, String endpointurl, String actionurl, String ns, String serviceName,
			String messageName, String body, String uid, String pwd) throws Exception {
		...
		try {
			if (!response.isCancelled()) {
				...
				if (response.getContext() != null) {
					Object responseHeaders = response.getContext().get(MessageContext.HTTP_RESPONSE_HEADERS);
					if (responseHeaders != null && responseHeaders instanceof Map) {
						this.resultHeaders = (Map<String, List<String>>) responseHeaders;
					}
				}
			} else {
				throw new InterruptedException(JBossJAXWSUIMessages.JAXRSWSTestView_Message_Service_Invocation_Cancelled);
			}
