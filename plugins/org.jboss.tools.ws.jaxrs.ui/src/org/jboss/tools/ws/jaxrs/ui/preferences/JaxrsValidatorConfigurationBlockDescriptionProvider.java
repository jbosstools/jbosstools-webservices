...
public class JaxrsValidatorConfigurationBlockDescriptionProvider {
	...
	private SectionDescription SECTION_RESOURCE_METHODS = new SectionDescription(
			...
			new String[][]{
					...
					{JaxrsPreferences.RESOURCE_METHOD_INVALID_ANNOTATED_PARAMETER_TYPE, JaxrsPreferencesMessages.JaxrsValidatorConfigurationBlock_pb_resourceMethodInvalidPathParamAnnotationValue_label},
