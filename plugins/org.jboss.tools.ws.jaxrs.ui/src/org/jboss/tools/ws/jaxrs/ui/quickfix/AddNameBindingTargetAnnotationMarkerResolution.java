...
public class AddNameBindingTargetAnnotationMarkerResolution extends AbstractAnnotationMarkerResolution  {
	 ...
	 */
	public AddNameBindingTargetAnnotationMarkerResolution(final IType type){
		super(type, JaxrsClassnames.TARGET,  AddNameBindingTargetValuesCompletionProposal.ANNOTATION_VALUE, AbstractAnnotationMarkerResolution.ADD,  NLS.bind(JaxrsQuickFixMessages.ADD_TARGET_ANNOTATION_MARKER_RESOLUTION_TITLE, type.getElementName()));
	}
