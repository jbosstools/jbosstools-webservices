...
public class JAXRSTester {
	 ...
	 */
	private String buildWebQuery(Set<WSProperty> parameters) throws Exception {
		if (!parameters.isEmpty()) {
	        StringBuilder sb = new StringBuilder();
	        for (WSProperty entry : parameters) {
     ...
     * @throws Exception
     */
    public void doTest (String address, Set<WSProperty> parameters, Set<WSProperty> headers) throws Exception {
     ...
     * @throws Exception
     */
    public void doTest (String address, Set<WSProperty> parameters, Set<WSProperty> headers, String methodType, String requestBody) throws Exception {
     ...
     * @throws Exception
     */
    public void doTest(String address, Set<WSProperty> parameters, Set<WSProperty> headers, String methodType, String requestBody, String proxy, String port) throws Exception {
     ...
     * @throws Exception
     */
    public void doTest(String address, Set<WSProperty> parameters, Set<WSProperty> headers, String methodType, String requestBody, String proxy, int port, String uid, String pwd) throws Exception {
        ...
        if (headers != null) {
        	for(WSProperty header: headers) {
        		httpurlc.addRequestProperty(header.getKey(), header.getValue());
        	}
        }
	    ...
	    if (resultBody == null || resultBody.trim().isEmpty()) {
	    	resultBody = JBossJAXRSUIMessages.JAXRSRSTestView_Message_Unsuccessful_Test;
	    }
