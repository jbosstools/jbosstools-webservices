...
/**
 * A TestLogger wrapper utility for classes in the current bundle only.
 */
public final class TestLogger {

	/** The 'info' level name, matching the .options file. */
	private static final String INFO = JBossJaxrsCoreTestPlugin.PLUGIN_ID + "/info";

	/** The 'debug' level name, matching the .options file. */
	private static final String DEBUG = JBossJaxrsCoreTestPlugin.PLUGIN_ID + "/debug";

	/** The 'debugIndexing' level name, matching the .options file. */
	private static final String DEBUG_INDEXING = JBossJaxrsCoreTestPlugin.PLUGIN_ID + "/debugIndexing";

	/** The 'trace' level name, matching the .options file. */
	private static final String TRACE = JBossJaxrsCoreTestPlugin.PLUGIN_ID + "/trace";

	/** The 'traceIndexing' level name, matching the .options file. */
	private static final String TRACE_INDEXING = JBossJaxrsCoreTestPlugin.PLUGIN_ID + "/traceIndexing";

	/** The 'tracePerf' level name, matching the .options file. */
	private static final String TRACE_PERF = JBossJaxrsCoreTestPlugin.PLUGIN_ID + "/tracePerf";
	...
	public static Status error(final String message, final Throwable t) {
		final Status status = new Status(Status.ERROR, JBossJaxrsCoreTestPlugin.PLUGIN_ID, message, t);
		if (JBossJaxrsCoreTestPlugin.getDefault() != null) {
			JBossJaxrsCoreTestPlugin.getDefault().getLog().log(status);
		} else {
	 ...
	 *            the message to log
	 */
	public static void error(String message, Throwable e, Object... items) {
		JBossJaxrsCoreTestPlugin.getDefault().getLog()
				.log(new Status(Status.ERROR, JBossJaxrsCoreTestPlugin.PLUGIN_ID, getMessage(message, items), e));
	}
	...
	public static void error(final String message) {
		JBossJaxrsCoreTestPlugin.getDefault().getLog()
				.log(new Status(Status.ERROR, JBossJaxrsCoreTestPlugin.PLUGIN_ID, message));
	}
	...
	public static void warn(final String message, final Throwable t) {
		JBossJaxrsCoreTestPlugin.getDefault().getLog()
				.log(new Status(Status.WARNING, JBossJaxrsCoreTestPlugin.PLUGIN_ID, message, t));
	}
	 ...
	 *            the throwable cause
	 */
	public static void warn(final String message, final Object... items) {
		JBossJaxrsCoreTestPlugin.getDefault().getLog()
				.log(new Status(Status.WARNING, JBossJaxrsCoreTestPlugin.PLUGIN_ID, getMessage(message, items)));
	}
	...
	public static void warn(final String message) {
		JBossJaxrsCoreTestPlugin.getDefault().getLog()
				.log(new Status(Status.WARNING, JBossJaxrsCoreTestPlugin.PLUGIN_ID, message));
	}
	...
	public static void info(String message) {
		if (isOptionEnabled(INFO)) {
			JBossJaxrsCoreTestPlugin.getDefault().getLog()
					.log(new Status(Status.INFO, JBossJaxrsCoreTestPlugin.PLUGIN_ID, message));
		}
	}
	...
	public static void info(String message, Object... items) {
		if (isOptionEnabled(INFO)) {
			JBossJaxrsCoreTestPlugin.getDefault().getLog()
			.log(new Status(Status.INFO, JBossJaxrsCoreTestPlugin.PLUGIN_ID, getMessage(message, items)));
		}
	}
	...
	private static boolean isOptionEnabled(String level) {
		...
		return JBossJaxrsCoreTestPlugin.getDefault() != null && JBossJaxrsCoreTestPlugin.getDefault().isDebugging()
